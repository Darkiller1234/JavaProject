...
//				
//			}*/ else {
//				User u = lc.getUser(id);
//				ss.Send(u.getName() + "님, 방문해주셔서 감사합니다.");
//				ss.Send(u.getName() + "님께서 맡기신 물건의 갯수는 ");
//				ss.Send("총 " + lc.StuffSize(id) + "개 입니다.");
...
//		try {
//			name = br.readLine();
//			String str = lc.CheckStuffName(id, name);
//			if (str.equals("")) {
...
//			String str = lc.CheckStuffCategory(id, category);
//			if (str.equals("")) {
