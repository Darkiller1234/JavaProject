...
public class Variable {
	...
	public static void main(String[] args) {
		...
		/*
		 * 실수 자료형 float(4), double(8) 실수를 저장하는 자료형으로 float보다 double이 더 정밀한 수를 표현할 수 있다.
		 */
		float fl = 4.24f;
		double dou = 4.24;
		...
		/*
		 * 문자 자료형 char(2) 문자 하나를 담을 수 있는 자료형 자바는 2바이트 유니코드로 표현한다.
		 */
		...
		/*
		 * 논리 자료형 boolean(1) true(참)와 false(거짓)를 저장하는 자료형
		 */
		...
		/*
		 * 문자열 String(==================객체===================) 문자열 같은 경우 할당해야할 메모리 크기가
		 * 너무 가변적이므로 원시타입이 아닌 객체로 변수를 만들어준다.
		 * 
		 */

		String str1 = "키스샷 아세로라오리온 하트언더블레이드";
		String str2;
		str2 = "ㅁㄴㅇㄹ";
		...
		String str = 123+45+"dd";
		System.out.println(str);
		String stt = "dd" + (123+45)+"dd";
